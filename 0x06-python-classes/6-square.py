...
class Square:
    ...
    def position(self, value):
        ...
        if not isinstance(value, tuple):                                                                                            raise TypeError('position must be a tuple of 2 positive integers')
        if len(value) != 2:
            raise TypeError('position must be a tuple of 2 positive integers')
        if len([i for i in value if isinstance(i, int) and i >= 0]) != 2:
            raise TypeError('position must be a tuple of 2 positive integers')
        self.__position = value                                                                                                                                                                                                                     def area(self):
    ...
    def pos_print(self):
        ...
        if self.size == 0:
            return "\n"
        for w in range(self.position[1]):                                                                                           pos += "\n"                                                                                                         for w in range(self.size):
    ...
    def my_print(self):                                                                                                         """print the square in position"""                                                                                      print(self.pos_print(), end='')
